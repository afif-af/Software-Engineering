...
//     const goto = (index) => {
//         setSlideIndex(index);
//         if (thumbRef.current) thumbRef.current.swiper.slideTo(index);
//         if (mainRef.current) mainRef.current.swiper.slideTo(index);
//     };
//
//     return (
//         <div className="flex gap-3">
...
//                         >
//                             <img src={productItem} alt="Product thumbnail 1" className="w-full" />
//                         </div>
//                     </SwiperSlide>
//
//                     <SwiperSlide>
...
//                                 : "opacity-40 border-transparent"}`}
//                         >
//                             <img src={productItem2} alt="Product thumbnail 2" className="w-full" />
//                         </div>
//                     </SwiperSlide>
//
//                     <SwiperSlide>
...
//                                 : "opacity-40 border-transparent"}`}
//                         >
//                             <img src={productItem} alt="Product thumbnail 3" className="w-full" />
//                         </div>
//                     </SwiperSlide>
//
//                     <SwiperSlide>
...
//                                 : "opacity-40 border-transparent"}`}
//                         >
//                             <img src={productItem2} alt="Product thumbnail 4" className="w-full" />
//                         </div>
//                     </SwiperSlide>
//
//                     <SwiperSlide>
...
//                                 : "opacity-40 border-transparent"}`}
//                         >
//                             <img src={productItem} alt="Product thumbnail 5" className="w-full" />
//                         </div>
//                     </SwiperSlide>
//
//                 </Swiper>
