            ...
            <div className="container">
                <div className="card shadow-md w-[400px] m-auto rounded-md bg-white p-5 px-10">
                    ...
                    <form className="w-full mt-5">
                        ...
                        <p className="text-center">Not Registered? <Link className="link  text-primary text-[14px] font-[600]" to="/register">Sign up</Link></p>



                        <p className="text-center fotn-[500]">Or continue with social account</p>
